...
const jurtProps = [
  {
    ...
    desc: (
      <>
        <div>Сен: "Гугу-гага" дедің</div>
        <div>Жұрттың баласы: Абайдың қара сөздерін жатқа айтып береді</div>
      </>
    ),
    img: <img
      src="/camry.png"
      alt="You and The Son of Mother's Friend"
    />
  },
  {
    val: 5,
  ...
  },
  {
    ...
    desc: (
      <>
        ...
        <div>Жұрттың баласы: уже 15-те барлық nFactorial курстарын бітіріп тастаған </div>
      </>
    )
  },
  {
    ...
    desc: (
      <>
        ...
        <div>Жұрттың баласы: Алматыдан он пәтер сатып алып, жалға береді- миллиардер</div>
      </>
    )
  },
  {
  ...
  },
  {
    ...
    desc: (
      <>
        ...
        <div>Жұрттың баласы: ата-анасын Меккеге бес рет арқалап апарып келді</div>
      </>
    )
  },
  {
  ...
  },
  {
    ...
    desc: (
      <>
        ...
        <div>Жұрттың баласы: жеті айронмен өтіп тастады, ультрамарафон жүгіреді</div>
      </>
    )
  },
  {
  ...
  },
  {
    ...
    desc: (
      <>
        ...
        <div>Жұрттың баласы: подъезд кеңесінің басшысы, ремонтқа ақша жинап жүр</div>
      </>
    )
  },
  {
    ...
    desc: (
      <>
        ...
        <div>Жұрттың баласы: 30-да зейнетақыға шығып кетіп, содан бері жұмыс істемейді</div>
      </>
    )
  },
  {
  ...
  },
  {
    ...
    desc: (
      <>
        ...
        <div>Жұрттың баласы: Подкаст ашып алған, бар әлем немерелеріне ақыл айтады</div>
      </>
    )
  }
]
